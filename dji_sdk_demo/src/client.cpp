...
static void Display_Main_Menu(void)
{
	...
	printf("| [r] Disarm the Drone          | [0] Geolocalization/Gimbal tests and AprilTag recognition)   |\n");
    printf("+-----------------------------------------------------------------+\n");
...
printf("\n and camera is roll %f pitch %f yaw %f ", drone->gimbal.roll, drone->gimbal.pitch, drone->gimbal.yaw);*/
			...
			case '0':
				...
				//The following while loop causes it to not print stuff or publish topics, so don't use it
				//while(drone->global_position.height< 0.5) //set low in case it doesn't reach the full 2 meters 
